...
assert.equal(n1.plus(n2).toString(), numbers.number1plus2);
assert.equal(n1.plus(n3).toString(), numbers.number1plus3);
assert.equal(n1.plus(n4).toString(), numbers.number1plus4);
