...
const buf = fs.readFileSync('./int64param.wasm');
...
Int64.prototype = {
    ...
    plus: function(anotherInt64) {
        waspInstance.exports.addTwo(this.low, this.high, anotherInt64.low, anotherInt64.high);
        return new Int64(waspInstanceMemoryBuffer);
    },
...
WebAssembly.compile(new Uint8Array(buf))
    ...
    .then(instance => {
        ...
        //assert(n1Int64.dividedBy(n5Int64).equals(n1divn5Int64));
        //assert(n1Int64.dividedBy(n6Int64).equals(n1divn6Int64));
        //assert(n1Int64.dividedBy(n7Int64).equals(n1divn7Int64));
